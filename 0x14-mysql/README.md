...
In this project it involved learning how to configure database servers in a
primary-replica model and I also configured the two servers provided to me by
